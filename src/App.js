      ...
      <div className="flex w-3/4 min-h-full rounded-3xl shadow-lg m-auto bg-gray-100">
        ...
        <div className="form-container">
          <div className="flex items-center justify-center">
            ...
            rounded-md bg-white bg-opacity-30">Pronóstico</h3>
          ...
          <div className="flex flex-col items-center justify-center h-full">
            <h1 className="text-white text-2xl">La unica aplicacion del clima que Necesitas</h1>
          ...
          <div className="flex flex-col my-10">
            ...
            {weatherData.length === 0 ? 
              ...
              <>
                ...
                <h1 className="text-3xl text-gray-600 mb-4 mt-10">Mas en {city}</h1>
