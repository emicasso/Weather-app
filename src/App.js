      ...
      <div className="flex w-3/4 min-h-full rounded-3x1 shadow-lg m-auto bg-gray-100">
        ...
        <div className="form-container">
          ...
          <div className="flex flex-col items-center justify-center h-full">
            <h1 className="text-white text-2x1">La única aplicación de pronóstico del tiempo que necesitas</h1>
        ...
        <div className='w-2/4 p-5'>
            ...
            <div className="flex flex-col my-10">
              {weatherData.length === 0 ? 
                <div className='container p-4 flex items-center justift-center h-1/3 mb-auto'>
                ...
                <>
                  ...
                  <h1 className='text-3xl text-gray-600 mb-4 mt-10'>Mas Info {City}</h1>
